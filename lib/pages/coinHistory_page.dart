...
class coinHistory_page extends StatefulWidget {
  const coinHistory_page({super.key});

  @override
  State<coinHistory_page> createState() => _coinHistory_pageState();
}

class _coinHistory_pageState extends State<coinHistory_page> {
